...
import com.MSGFCentralSys.MSGFCentralSys.services.CreditCommittee_EvaCre;
...
public class CreditCommitteController {
    private final CreditCommittee_EvaCre creditCommitteeEvaCre;
    ...
    public String CreditCommitteView(Model model) throws IOException {
        List<String> processIds = this.creditCommitteeEvaCre.getAllProcessByActivityId("Activity_0rzlyv4");
        ...
        for (String processId : processIds) {
            CreditRequestDTO creditRequestDTO = this.creditCommitteeEvaCre.getProcessVariablesById(processId);
            TaskInfo taskInfo = this.creditCommitteeEvaCre.getTaskInfoByProcessId(processId);
    ...
    public String approveTaskCouple(@RequestParam(name = "processId") String processId){
        this.creditCommitteeEvaCre.approveTask(processId);
    ...
    public String rejectTaskCreditAnalyst(@RequestParam(name = "processId") String processId){
        this.creditCommitteeEvaCre.rejectTask(processId);
        return "redirect:/credit-committee";
    }
}
